Locales["en"] = { 
    ...
    ["YELLOW_PAGES_EMPTY"] = "Tidak dapat membiarkan ruang kosong",
    ["YELLOW_PAGES_COPY_NUMBER"] = "Menyalin nomor telepon",
    ["YELLOW_PAGES_CANT_DO_THIS"] = "Tidak bisa melakukan itu...",
    ["YELLOW_PAGES_DELETE_ADVERT"] = "menghapus postingan",
    ["GENERAL_TAKE_A_PHOTO"] = "Mengabil Foto",

    ['BUSINESS_TITLE'] = 'Google My Business',
    ['BUSINESS_ALERT_DESCRIPTION'] = 'New Alert on My Business',
    ['BUSINESS_ALERT_ERROR'] = 'Kesalahan mengirim permintaan',
    ...
    ["BANK_DONT_ENOUGH"] = 'Anda tidak memilik cukup uang di Bank!',
    ["BANK_NOIBAN"] = "There is no IBAN associated with this person!",
    ["BANK_IBAN_COPY"] = "You copied your IBAN",
    ["BANK_SEND_MONEY"] = "You sent Rp.",
    ["BANK_INVOICE_PAID"] = "You paid an invoice for Rp.",
    ["BANK_REMOVE_MONEY"] = "You withdrew money from your bank Rp.",
    ["BANK_NOT_IBAN"] = "This IBAN does not exist",
    ["BANK_TRANSFER_SUCCESS"] = "Successful money transfer!",
    ["BANK_RECEIVED"] = "The money has been transferred to your account Rp.",
    ["BANK_INVOICE_PAY"] = "You paid an invoice",
    ["BANK_TRANSFER"] = "They transferred Rp. to you",
    ["SENDER_PHONE"] = "Sender Phone:",
    ['INVOICE_PAYMENT_RECEIVED'] = 'Penalty payment received for Rp.',
    ...
    ["UBERDRIVER_CANCEL_REQUEST"] = "If you cancel the request, you will have to pay Rp.5000",
    ["UBERDRIVER_CHOOSE_PRICE"] = "You need to enter a rate...",
    ["UBERDRIVER_CONFIRM_PRICE"] = "Are you sure about your rate? Rate: Rp.",
    ...
    ["UBERDRIVER_CANCEL_REQUEST_1"] = "Your driver canceled the request. Rp.5000 credited to your account",
    ["UBERDRIVER_CANCEL_REQUEST_2"] = "Rp.5000 has been credited to your account because the person canceled the request",
    ["UBERDRIVER_NO_MONEY"] = "You need a minimum of Rp.5000",
    ["UBERDRIVER_ALREADY_UBER"] = "You're Uber, you can't hail a car",
    ["UBERDRIVER_DRIVER_PAY"] = "A total of Rp.",
    ["UBERDRIVER_CUSTOMER_PAY"] = "You paid Rp.",
    ...
    ["PASSWORD_RESET_TECH_OPTION"] = "Reset Passwords Rp.",
    ...
    ["BOOTH_DRAWTEXT_CALL"] = "Call cost: Rp.",
    ...
    ["BOOTH_NOTIFICATION_TOTAL_COST"] = "Call cost: Rp.",
    ["BOOTH_NOTIFICATION_EMERGENCY_CALL_ERROR"] = "No one is available to take your call",
    ["BOOTH_MENU_TITLE"] = "Call price: Rp.1/sec",
    ...
    ["CRYPTO_COUNTRY_CURRENCY_SYMBOL"] = "Rp.",
